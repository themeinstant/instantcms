...
FCKConfig.ToolbarSets["Admin"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Table','Rule','Smiley','SpecialChar', 'Image'],
	'/',
...
FCKConfig.ToolbarSets["Basic"] = [
    ['FitWindow'],
	['Bold','Italic','Underline','StrikeThrough','-','OrderedList','UnorderedList','-','Image','Link','Unlink'],
    ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Rule','Smiley','SpecialChar'],
    ['FontFormat','FontName','FontSize']
] ;
