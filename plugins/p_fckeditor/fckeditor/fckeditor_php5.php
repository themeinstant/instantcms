...
function FCKeditor_IsCompatibleBrowser()
{
    ...
    {
        $iVersion_old = (int)mb_substr($sAgent, mb_strpos($sAgent, 'Gecko/') + 6, 8) ;
        $iVersion_new = (int)mb_substr($sAgent, mb_strpos($sAgent, 'Gecko/') + 6, 2) ;
        return ($iVersion_old >= 20030210 || $iVersion_new >= 16) ;
    }
