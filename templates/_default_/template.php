...
<head>
    ...
    <?php if($inUser->is_admin){ ?>
        ...
        <script src="/templates/<?php echo $inConf->template; ?>/js/nyromodal.js" type="text/javascript"></script>
        <link href="/templates/<?php echo $inConf->template; ?>/css/modconfig.css" rel="stylesheet" type="text/css" />
        <link href="/templates/<?php echo $inConf->template; ?>/css/nyromodal.css" rel="stylesheet" type="text/css" />
    <?php } ?>
    <link href="/templates/<?php echo $inConf->template; ?>/css/reset.css" rel="stylesheet" type="text/css" />
    <link href="/templates/<?php echo $inConf->template; ?>/css/text.css" rel="stylesheet" type="text/css" />
    <link href="/templates/<?php echo $inConf->template; ?>/css/960.css" rel="stylesheet" type="text/css" />
    <link href="/templates/<?php echo $inConf->template; ?>/css/styles.css" rel="stylesheet" type="text/css" />
</head>
        ...
        <div class="container_12">
            ...
            <div class="grid_4 foot_right">
                <a href="http://www.instantcms.ru/" title="Работает на InstantCMS" target="_blank">
                    <img src="/templates/<?php echo $inConf->template; ?>/images/b88x31.gif" border="0"/>
                </a>
            </div>
        </div>
    </div>
