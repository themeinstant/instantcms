<div class="friend_list_top">
  <input id="friend_list_lookup" class="inputText" type="text"  onkeydown="clubs.intive_search();" onblur="{literal}if ($(this).val()==''){ $(this).val('поиск'); }" onclick="$(this).val('');{/literal}" value="поиск" />
  <div id="list_tab" class="t_filter_selected" onclick="clubs.intive_filter('all')">
    <div class="t_filter2">
      <div class="t_filter3">Все</div>
    </div>
  </div>
  <div id="list_selected_tab" class="t_filter_off" onclick="clubs.intive_filter('checked')">
    <div class="t_filter2">
      <div class="t_filter3">Отмеченные (<span id="count_friends">0</span>)</div>
    </div>
  </div>
</div>
