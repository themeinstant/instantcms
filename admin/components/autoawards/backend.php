					...
					?>
                        ...
                        <table border="0" cellspacing="0" cellpadding="4"><tr>
                             <?php if ($mod['imageurl'] != $img){ ?>
                                <td align="center" valign="middle"><img src="/images/users/awards/<?php echo $img; ?>" /><br/><input type="radio" name="imageurl" value="<?php echo $img; ?>"/></td>
                             <?php } else {  ?>
                                <td align="center" valign="middle"><img src="/images/users/awards/<?php echo $img; ?>" /><br/><input type="radio" name="imageurl" value="<?php echo $img; ?>" checked="checked"/></td>
                             <?php } ?>
                        </tr></table></div>
                    <?php } ?>
                    </td>
